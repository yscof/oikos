...
**목적·타겟 (2026-07 확정):** 타겟은 **소비 습관 형성이 필요한 사람**(가계부 무경험자, 며칠 만에 포기해본 사람)이고, 오이코스는 그들의 소비 습관이 자리 잡는 **기초가 되는 가계부**다. 단, 습관 형성의 수단은 게임화(스트릭·배지·리마인더)가 아니라 낮은 마찰(3초 기록)과 담백한 피드백(인사이트 문장) — 기존 제품 원칙(게임화 금지·톤 계약)을 그대로 유지한다. 이해(기존 철학)는 수단, 습관 형성은 결과.
